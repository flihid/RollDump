export default function SecuritySettings() {
  return (
    <div className="card p-6 space-y-3">
      ...
      <p className="text-sm text-ink-700">TOTP-based 2FA is coming in a future release. For now, use a strong password and review your active sessions regularly.</p>
